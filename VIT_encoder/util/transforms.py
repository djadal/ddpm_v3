...
class BandpassFilter(SOSFilter):
    """Apply bandpass filter to the input sequence.
    """
    def __init__(self, fs: int, cutoff: tuple, order: int = 5) -> None:
        super(BandpassFilter, self).__init__(fs, cutoff, order, btype='bandpass')
